                  ...
                  <div className="signup-box-bottom">
                    <div className="signup-box-content">
                      ...
                      <form>
                        ...
                        <button type="submit" className="btn-default" href="/profile-details">
                          Sign In
                        </button>
                      </form>
                    </div>
                ...
                <div className="client-feedback-area">
                  <div className="single-feedback">
                    <div className="inner">
                      ...
                      This AI-powered fashion store has completely transformed how I shop!
                       It’s so easy to find outfits that match my style, and the recommendations 
                       feel like they were made just for me. Absolutely love it!
                    </p>

                        <div className="bottom-content">
                          <div className="meta-info-section">
                            <h4 className="title-text mb--0">Guy Hawkins</h4>
                            <p className="desc mb--20">Fashion Designer</p>
